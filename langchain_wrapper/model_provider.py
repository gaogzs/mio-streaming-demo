...
class ModelProvider:
  ...
  def _create_deepseek_model(
    ...
    **kwargs
    ...
    if not api_key:
      raise ValueError("未配置 DeepSeek API Key，请设置环境变量 DEEPSEEK_API_KEY 或在 secrets/api_keys.json 中配置")

    base_url = self._get_secret("deepseek_base_url") or "https://api.deepseek.com"
